...
class ScrollSwap(DEX):
    def __init__(self, client):
        self.client = client

        self.router_contract = self.client.get_contract(SCROLLSWAP_CONTRACT['router'], SCROLLSWAP_ABI)
    ...
    async def swap(self):
        ...
        if from_token_name != 'ETH':
            await self.client.check_for_approved(from_token_address, SCROLLSWAP_CONTRACT['router'], amount_in_wei)
