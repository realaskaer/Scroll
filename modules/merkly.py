...
class Merkly(Refuel):
    def __init__(self, client):
        ...
        self.refuel_contract = self.client.get_contract(MERKLY_CONTRACTS['gas_refuel'], MERKLY_ROUTER_ABI)
        self.router_contract = self.client.get_contract(MERKLY_CONTRACTS['router'], MERKLY_ROUTER_ABI)
